    ...
    <section className="py-16 md:py-24 bg-[#fbfbf9] relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-12 relative z-10">
        <div className="flex flex-col items-center mb-12 md:mb-16 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-['Playfair_Display',serif] text-naka-blue uppercase tracking-wider">
            TRA CỨU SẢN PHẨM
          </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-0 lg:gap-1 mb-4 md:mb-6 bg-white shadow-xl  mx-auto">
          <div className="flex-1 lg:w-1/3 bg-naka-blue text-white p-6 md:p-8 lg:p-12 flex flex-col justify-center items-start relative overflow-hidden group min-h-[250px] lg:min-h-[300px]">
            ...
            <h3 className="text-lg font-bold tracking-[0.2em] mb-2 uppercase z-10">
              Tra theo loại cửa
            </h3>
            <span className="text-[10px] tracking-[0.25em] uppercase opacity-70 mb-8 z-10 block">
              Search by Set
            </span>
            <div className="w-8 h-px bg-white/30 mb-8 z-10"></div>
            <p className="text-xs font-light leading-relaxed opacity-80 z-10 max-w-[80%]">
          ...
          <div className="flex-1 lg:w-2/3 grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-100 bg-white">
            <div className="relative group p-6 md:p-8 flex flex-col items-center text-center hover:bg-slate-50 transition-colors cursor-pointer">
              ...
              <h4 className="font-['Playfair_Display',serif] text-xl text-naka-blue font-bold mb-2">
                Cửa trượt
              </h4>
              <span className="text-[10px] text-slate-400 uppercase tracking-wider mb-6 block">
                Sliding Door Systems
              </span>
              <button className="text-xs font-bold text-naka-blue uppercase tracking-[0.25em] border-b border-naka-blue/20 hover:border-naka-blue pb-1 transition-all">
                Xem chi tiết
              </button>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-0 lg:gap-1 mb-4 md:mb-6 bg-white shadow-xl  mx-auto">
          <div className="flex-1 lg:w-1/3 bg-[#152a55] text-white p-6 md:p-8 lg:p-12 flex flex-col justify-center items-start relative overflow-hidden group min-h-[200px] lg:min-h-auto">
            ...
            <div className="w-8 h-px bg-white/30 mb-8 z-10"></div>
            <p className="text-xs font-light leading-relaxed opacity-80 z-10 max-w-full md:max-w-[80%]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  <span className="font-bold text-slate-700 text-sm group-hover:text-naka-blue">
                    Bản lề
                  </span>
        ...
        <div className="flex flex-col lg:flex-row bg-naka-blue text-white max-w-6xl mx-auto shadow-2xl">
          <div className="lg:w-1/3 p-6 md:p-8 lg:p-12 flex flex-col justify-center bg-[#152a55] order-2 lg:order-1">
            <span className="text-[10px] font-bold tracking-[0.4em] uppercase mb-2 text-[#c5a059]">
              Sản phẩm tiêu biểu
            </span>
            <h3 className="text-3xl font-['Playfair_Display',serif] mb-2">
              Shuttle Closer
            </h3>
            <span className="text-xs text-white/50 tracking-[0.25em] uppercase mb-6 block">
              Hệ thống đóng tự động
            </span>
            <div className="w-12 h-px bg-white/20 mb-6"></div>
            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-3 text-xs font-light text-white/80">
            ...
            <button className="self-start text-[10px] font-bold uppercase tracking-[0.25em] border border-white/30 px-6 py-3 hover:bg-white hover:text-naka-blue transition-all cursor-pointer">
              Xem kỹ thuật
            </button>
          </div>
