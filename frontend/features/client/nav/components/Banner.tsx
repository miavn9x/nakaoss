...
const Banner = async () => {
  ...
  return (
    <div className="bg-naka-blue text-white relative">
      ...
      <div className="container mx-auto px-4 py-8 md:py-12 flex items-center justify-between overflow-hidden">
        ...
        <div className="hidden md:block w-32 h-32 lg:w-40 lg:h-40 rounded-full border-4 border-white/30 overflow-hidden bg-white/10 shrink-0 shadow-lg relative z-10">
        ...
        <div className="flex-1 text-center z-10 px-4">
          <h1 className="text-3xl md:text-5xl font-serif font-bold uppercase tracking-wider text-white drop-shadow-md mb-2">
            {t("title")}
          </h1>
