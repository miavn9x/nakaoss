    ...
    <section className="mt-24">
      <div className="flex items-center justify-between mb-10 border-b border-gray-100 pb-4">
        <h3 className="font-serif text-2xl md:text-3xl text--naka-blue font-bold flex items-center gap-3">
          ...
          Chi tiết kỹ thuật: SERIES K-150
        </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-white rounded-[8px] overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 border border-gray-200 group flex flex-col h-full">
          <div className="relative h-72 bg-white p-6 flex items-center justify-center border-b border-gray-100">
            <div className="absolute top-4 left-4 bg-gray-100 text--naka-blue text-[10px] font-bold px-3 py-1 rounded-[4px] uppercase tracking-wider border border-gray-200 z-10">
              Anodized Finish
            </div>
            <img
          ...
          <div className="p-6 flex-1 flex flex-col">
            <h4 className="font-bold text-lg text--naka-blue mb-2">
            ...
            <button className="w-full py-3 px-4 rounded-[4px] border border--naka-blue text--naka-blue hover:bg--naka-blue hover:text-white font-bold text-xs transition-all duration-300 tracking-wider uppercase flex items-center justify-center gap-2">
              Thông số kỹ thuật{" "}
