          ...
          <article className="prose prose-slate max-w-none">
            <section>
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                Nakao tự hào là thương hiệu hàng đầu trong lĩnh vực phụ kiện cửa
                cao cấp, với bề dày lịch sử phát triển bền vững. Chúng tôi không
                chỉ cung cấp sản phẩm, mà còn kiến tạo những giải pháp an toàn
                và thẩm mỹ cho mọi công trình kiến trúc tại Việt Nam.
              </p>
              <p className="text-slate-700 leading-relaxed">
                Với "Tầm nhìn 100 năm", Nakao cam kết xây dựng một đội ngũ nhân
                sự chuyên nghiệp, lấy sự hài lòng của khách hàng làm trọng tâm
                và không ngừng đổi mới công nghệ để dẫn đầu thị trường khu vực
                Đông Nam Á.
              </p>
            </section>
            ...
            <section className="mt-12">
              ...
              <ul className="space-y-4 text-slate-700 list-none p-0">
                <li className="flex gap-3">
                  ...
                  <span>
                    Tư vấn kỹ thuật và đưa ra giải pháp phụ kiện cửa tối ưu cho
                    các dự án chung cư cao cấp, khách sạn và cao ốc văn phòng.
                  </span>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-6 h-6 text-[#1152d4] shrink-0 mt-0.5" />
                  <span>
                    Phối hợp cùng các đơn vị thiết kế, nhà thầu để bóc tách khối
                    lượng và lập bảng dự toán kỹ thuật.
                  </span>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-6 h-6 text-[#1152d4] shrink-0 mt-0.5" />
                  <span>
                    Hỗ trợ đội ngũ kinh doanh trong việc đàm phán các yêu cầu kỹ
                    thuật đặc thù của khách hàng.
                  </span>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-6 h-6 text-[#1152d4] shrink-0 mt-0.5" />
                  <span>
                    Giám sát quy trình lắp đặt mẫu tại công trường và đào tạo kỹ
                    thuật cho đối tác thi công.
                  </span>
                </li>
              </ul>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 bg-slate-50 rounded-xl border border-slate-100">
                  <h3 className="font-bold mb-3 flex items-center gap-2">
                    <GraduationCap className="w-5 h-5 text-[#1152d4]" /> Kỹ năng
                    & Kinh nghiệm
                  </h3>
                  <ul className="text-sm space-y-2 text-slate-600 list-disc pl-4">
                    <li>
                      Tốt nghiệp Đại học chuyên ngành Xây dựng, Kiến trúc hoặc
                      Cơ khí.
                    </li>
                    <li>Ít nhất 2 năm kinh nghiệm tại vị trí tương đương.</li>
                    <li>
                      Sử dụng thành thạo AutoCAD và các phần mềm văn phòng.
                    </li>
                  </ul>
                </div>
                <div className="p-6 bg-slate-50 rounded-xl border border-slate-100">
                  <h3 className="font-bold mb-3 flex items-center gap-2">
                    <Brain className="w-5 h-5 text-[#1152d4]" /> Thái độ & Tố
                    chất
                  </h3>
                  <ul className="text-sm space-y-2 text-slate-600 list-disc pl-4">
